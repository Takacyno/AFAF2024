	...
	<div class="c-area__content">
		<div class="p-partners__wrapper">
			...
			<div class="p-partners__content">
				...
				?>
					<div class="p-partners__sponsored js-fadein">
				...
				?>
					<div class="p-partners__sponsorship js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>協賛</h2>
						<?php else: ?>
						<h2>Partners</h2>
				...
				?>
					<div class="p-partners__special js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>特別協力</h2>
						<?php else: ?>
				...
				?>
					<div class="p-partners__associated js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>協力</h2>
						<?php else: ?>
				...
				<?php
					...
					if ($other) :
				?>
					<div class="p-partners__other js-fadein">
						<?php echo $other; ?>
					</div>
				<?php endif; ?>
				<?php
				...
				?>
					<div class="p-partners__media js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>メディアパートナー</h2>
						<?php else: ?>
						<h2>Media Partner</h2>
				...
				?>
					<div class="p-partners__museum js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>特別協力美術館・博物館</h2>
						<?php else: ?>
				...
				?>
					<div class="p-partners__fair js-fadein">
						<?php if ($currentLang != 'en_US') : ?>
						<h2>アートフェアパートナー</h2>
						<?php else: ?>
